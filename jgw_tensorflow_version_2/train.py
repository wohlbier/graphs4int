...
from graphsaint.jgw_tensorflow_version_2.inits import *
from graphsaint.jgw_tensorflow_version_2.model import GraphSAINT
from graphsaint.jgw_tensorflow_version_2.minibatch import Minibatch
...
#     summary_writer = tf.compat.v1.summary.FileWriter(log_dir(args_global.train_config,args_global.data_prefix,git_branch,git_rev,timestamp), sess.graph)
    summary_writer = tf.compat.v1.summary.FileWriter(log_dir(args_global.train_config,args_global.data_prefix,git_branch,git_rev,timestamp))
